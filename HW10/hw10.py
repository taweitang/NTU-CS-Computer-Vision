...
cv2.imwrite('Laplacian1_15.bmp', reverse_thresholding(Laplacian1, 15))
cv2.imwrite('Laplacian2_15.bmp', reverse_thresholding(Laplacian2, 15))
...
cv2.imwrite('Laplacian_of_Gaussian_3000.bmp', reverse_thresholding(Laplacian_of_Gaussian, 3000))
...
cv2.imwrite('Difference_of_Gaussian_1.bmp', reverse_thresholding(reverse_thresholding(Difference_of_Gaussian, 1)))
